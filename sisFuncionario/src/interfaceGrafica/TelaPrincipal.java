...
public class TelaPrincipal {
	...
	public void menuPrincipal() {
		...
		frameMenuPrincipal.setSize(200,200);// Tamanho da janela
		
		JPanel panelMenuPrincipal = new JPanel();//Painel para organizar os itens dentro do painel
		
		JLabel labelOpcao1 = new JLabel("1 - CADASTRO SUPERVISOR");// Criar a primeira label
		panelMenuPrincipal.add(labelOpcao1);// Adiciona a primeira label dentro do painel
		
		JLabel labelOpcao2 = new JLabel("2 - CADASTRO ASSISTENTE");//Cria a segunda Label
