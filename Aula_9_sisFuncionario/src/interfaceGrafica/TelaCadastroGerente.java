...
public class TelaCadastroGerente {
	...
	public void formularioGerente() {
		...
		frameCadastroGerente.setSize(350 , 350);
		...
		ControladorTelaCadastroGerente controladorTelaCadastroGerente = new ControladorTelaCadastroGerente(textNome, textCpf, textGerencia);
