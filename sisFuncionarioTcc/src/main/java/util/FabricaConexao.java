...
public class FabricaConexao {
	...
	private static String BANCO_URL = "jdbc:mysql://localhost:3306/sis_funcionarioTcc?useTimezone=true&serverTimezone=UTC";// URL
																														// DO
																														// BANCO

	// Metodo da Classe
	public static Connection criarConexaoSisFuncionarioTcc() {
		...
		try {
			...
			conexao = DriverManager.getConnection(BANCO_URL, USUARIO, SENHA);// Tenta acessar o banco de dados e criar oobjeto
