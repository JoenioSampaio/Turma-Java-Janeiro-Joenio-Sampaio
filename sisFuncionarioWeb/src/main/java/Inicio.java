...
public class Inicio extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String titulo = "<h2>Teste GET → POST</h2>";
		...
		String html = "<!DOCTYPE html>" + "<html lang='pt-br'>" + "<head>" + "  "
				...
				"    <label>Digite algo:</label><br>" + // Como se fosse o Jlabel
				"    <input type='text' name='texto' required>" + // Como se fosse o JTextFiedl
				"    <br><br>" + "    <button type='submit'>Enviar</button>" + "  </form>" +

				"</body>" + "</html>";

		response.getOutputStream().write(html.getBytes(StandardCharsets.UTF_8));// Enviando a resposta para o Cliente no servidor WEB
	}
